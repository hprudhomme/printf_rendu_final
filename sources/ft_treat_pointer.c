...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/01/21 12:09:16 by hprudhom          #+#    #+#             */
/*   Updated: 2021/04/14 13:42:32 by hprudhom         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/ft_printf.h"

static int	ft_put_arg(char *pointer, t_flags flags)
{
	int	char_count;
...
int	ft_treat_pointer(unsigned long long ull, t_flags flags)
{
	...
	if (flags.minus == 1)
		char_count += ft_put_arg(pointer, flags);
